...
/** @type {string} */
const CACHE_VERSION = '1743548338|87826037442';
/** @type {string} */
const CACHE_PREFIX = 'Square Mile Team-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Square Mile Team MakerV1-2.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Square Mile Team MakerV1-2.html","Square Mile Team MakerV1-2.js","Square Mile Team MakerV1-2.offline.html","Square Mile Team MakerV1-2.icon.png","Square Mile Team MakerV1-2.apple-touch-icon.png","Square Mile Team MakerV1-2.audio.worklet.js","Square Mile Team MakerV1-2.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Square Mile Team MakerV1-2.wasm","Square Mile Team MakerV1-2.pck"];
